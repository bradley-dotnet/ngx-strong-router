...
export interface LazyChild<TNavTargets, TComponent extends number> extends Omit<EagerRoute<TNavTargets>,
    'component' | 'providers' | 'children' | 'canActivate' | 'canActivateChild' | 'resolve' | 'canLoad' | 'canDeactivate'> {
